...
* 3. Run event-study regression - Is abortion justifiable
reghdfe F120 pl_et1-pl_et23 Year Sex Age Marital_status dummy_muslim ///
...
twoway (rcap min95 max95 years_before_placebo, lcolor(red)) ///
       ...
       xtitle("Years before legalization") ///
       ytitle("Change in public acceptance of abortion") ///
       title("Placebo Event-Study: Public Acceptance of Abortion Before Legalization") ///
